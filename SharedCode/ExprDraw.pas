  ...
  uses Windows,Classes,SysUtils,Graphics,Math;
   ...
   const efLeft=1;
    ...
    type TExprOrigin=(eoTop,eoBottom);
         ...
         TExprCapStyle=(ecPoints,ecVector,ecCap,ecTilde,ecLine,ecBottomLine);
   ...
   function TExprCap.CalcWidth;
    var DLeft,DRight,W,CX:Integer;
     begin
      ...
      if Style in [ecVector,ecLine,ecBottomLine] then
       begin
        if DLeft<0 then
         Dec(Result,DLeft);
        if DRight>0 then
     ...
     begin
      ...
      case Style of
       ...
       ecLine:begin
        ...
        ecBottomLine: begin
               SetCanvasFont;
               Canvas.Rectangle(LX-1,DY+Height-2*WY-2,RX-3,DY+Height-WY-2);
            end;
        end;
     end;
