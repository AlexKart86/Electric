    ...
    var B:TExprClass;
     ...
     begin
      ...
      case S[P] of
       ...
       'a'..'z', 'A'..'Z', 'А','Б','В','Г','Д','Е','Ё','Ж','З','И','Й','К','Л','М','Н','О',
   ...
   function TExprBuilder.Func;
    var N:string;
     ...
     begin
      N:=S[P];
      Inc(P);
      while S[P] in ['a'..'z', 'A'..'Z', 'А','Б','В','Г','Д','Е','Ё','Ж','З','И','Й','К','Л','М','Н','О',
                   'П','Р','С','Т','У','Ф','Х','Ц','Ч','Ш','Щ','Ъ','Ы','Э','Ю','Я',
                   'а','б','в','г','д','е','ё','ж','з','и','й','к','л','м','н','о',
                   'п','р','с','т','у','ф','х','ц','ч','ш','щ','ъ','ы','э','ю','я'] do
       begin
        N:=N+S[P];
        Inc(P)
       end;
   ...
   function TExprBuilder.FuncName;
    var A,C,D,D2:TExprClass;
     ...
     begin
      ...
      if M='BLINE' then begin
                        A:=ExprString(EExpression);
                        if Build then
                         Result:=MakeCap(A,ecBottomLine,0)
                        else
                         Result:=nil
                       end else
    ...
    var M:string;
     ...
     begin
      ...
      if M='EMPTY' then if Build then
       ...
       if Build then
        if N[1] in ['a'..'z', 'A'..'Z', 'А','Б','В','Г','Д','Е','Ё','Ж','З','И','Й','К','Л','М','Н','О',
                   'П','Р','С','Т','У','Ф','Х','Ц','Ч','Ш','Щ','Ъ','Ы','Э','Ю','Я',
                   'а','б','в','г','д','е','ё','ж','з','и','й','к','л','м','н','о',
                   'п','р','с','т','у','ф','х','ц','ч','ш','щ','ъ','ы','э','ю','я'] then
